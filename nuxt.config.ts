...
const productionRouteRules =
  process.env.NODE_ENV === 'production'
    ? {
        ...
        '/api/news': { isr: 30 * 60 },
        '/api/myanimelist/az': { isr: 60 * 60 },
        '/api/myanimelist/catalog': { isr: 60 * 60 },
        '/api/myanimelist/filter': { isr: 30 * 60 },
        '/api/myanimelist/home-discover': { isr: 60 * 60 },
        '/api/myanimelist/home-lists': { isr: 60 * 60 * 6 },
        '/api/myanimelist/schedule': { isr: 30 * 60 },
        '/api/myanimelist/search': { isr: 15 * 60 },
        '/api/myanimelist/spotlight': { isr: 60 * 60 * 6 },
        '/api/myanimelist/trending': { isr: 60 * 60 },
        '/api/myanimelist/genre/**': { isr: 60 * 60 },
        '/api/myanimelist/hover/**': { isr: 60 * 60 * 6 },
        '/api/myanimelist/**': { isr: 60 * 60 },
      }
    : {}
